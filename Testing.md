...
Highlight updates correctly when sorting changes
9. Accessibility

I tested accessibility using Chrome Lighthouse.

The application achieved a score of 100 in Accessibility
10. Unit Tests
